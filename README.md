...
1. **Robust Document Ingestion (Loaders & Metadata):**
...
2. **Semantic Chunking (Text Splitters):**
...
3. **Vector Store Initialization (Embeddings & ChromaDB):**
